'''
Source - https://github.com/abdur75648/UTRNet-High-Resolution-Urdu-Text-Recognition/blob/main/modules/cnn/hrnet.py
An implementation from this paper - https://arxiv.org/abs/2306.15782
'''
...
class HRNet(nn.Module):
    ...
    def forward(self, x,hs = None):
        ...
        return tuple(res_list),x

# x = [torch.randn(1, 64, 32, 400),torch.randn(1, 128, 16, 200), torch.rand(1, 256, 8, 100)]
# # model = HRNet(in_ch=1, out_ch=32, mid_ch=64)
# x = torch.randn(8, 3, 256, 256)
# model = HRNet(in_ch=3, out_ch=1, mid_ch=32,num_stage=4)
# anch, cal = model(x)
# print("Generic Highway U-Net Output")
# print("Tuple anch[0]:",anch[0].shape) # torch.Size([8, 32, 256, 256])
# print("Tuple anch[1]:",anch[1].shape) # torch.Size([8, 64, 256, 256])
# print("Tuple anch[2]:",anch[2].shape) # torch.Size([8, 128, 256, 256])
# print("Tuple anch[3]:",anch[3].shape) # torch.Size([8, 256, 256, 256])
# print("cal:",cal.shape) # [8, 1, 256, 256]