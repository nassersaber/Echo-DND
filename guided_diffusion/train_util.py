...
# Device = th.device(f"cuda") if th.cuda.is_available() else th.device("cpu")
...
class TrainLoop:
    ...
    def _load_ema_parameters(self, rate):
        ...
        if ema_checkpoint:
            ...
            state_dict = th.load(ema_checkpoint, map_location=self.device) # dist_util.load_state_dict(
    ...
    def forward_backward(self, batch, cond):
        ...
        for i in range(0, batch.shape[0], self.microbatch):
            ...
            compute_losses = functools.partial(
                self.diffusion.training_losses_segmentation, # LossType=MSE (From guided_diffusion.guided_diffusion.py)
                self.ddp_model, # UNetModel_newpreview
    ...
    def save(self):
        ...
        # print("Disabled saving optsavedmodels in guided_diffusion/train_util.py (line 300)")
        # print("Disabled saving emasavedmodels in guided_diffusion/train_util.py (line 300)")
        # for rate, params in zip(self.ema_rate, self.ema_params):
